...
def reorder_roll_numbers(apps, schema_editor):
    ...
    for student in students:
        student.roll_number = f"__reorder__{student.pk}"
...
class Migration(migrations.Migration):
    dependencies = [
        ("Students", "0013_backfill_face_images"),
    ]

    operations = [
        migrations.RunPython(reorder_roll_numbers, reverse_reorder),
    ]
